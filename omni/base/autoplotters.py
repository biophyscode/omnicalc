...
def inject_supervised_plot_tools(out,mode='supervised'):
	...
	#! import store
	from omni.base.store import store
	...
	from omni.base.store import plotload,picturesave
	...
	from omni.base.hypothesis import hypothesis,sweeper
	...
	from omni.datapack import asciitree
	def key_types(obj):
